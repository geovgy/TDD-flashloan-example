...
describe("Flashloan Test", function () {
  ...
  const addressForDAI = "0x6B175474E89094C44Da98b954EedeAC495271d0F"; // <= DAI on Mainnet
  ...
  it("Send DAI to contract", async function () {
  ...
  it("Flashloan executes successfully", async function () {
    const loanAmount = ethers.utils.parseEther('100');

    const flashloanTx = await instance.flashloanCall(addressForDAI, loanAmount);
